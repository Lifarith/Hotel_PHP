        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Administrar habitaciones
                    <button class="btn btn-secondary pull-right" style="border-radius:0%" data-toggle="modal" data-target="#addRoom">Crear habitacion</button>
                </div>
                            ...
                            while ($rooms = mysqli_fetch_assoc($rooms_result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($rooms['status'] == 0) {
                                            echo '<a href="index.php?reservation&room_id=' . $rooms['room_id'] . '&room_type_id=' . $rooms['room_type_id'] . '" class="btn btn-success" style="border-radius:0%">Disponible</a>';
                                        } else {
                                            echo '<a href="#" class="btn btn-danger" style="border-radius:0%">Ocupada</a>';
                                        }
                                        ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="ajax.php?delete_room=<?php echo $rooms['room_id']; ?>"
                                           class="btn btn-danger" style="border-radius:60px;" onclick="return confirm('Desea eliminar la habitacion?')"><i
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Crear nueva habitacion</h4>
                </div>
                            ...
                            <form id="addRoom" data-toggle="validator" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="room_type_id" required
                                            data-error="Seleccione tipo de habitacion">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Ingrese numero de habitacion" id="room_no"
                                           data-error="Ingrese numero de habitacion" required>
                                    <div class="help-block with-errors"></div>
                                </div>
    ...
    <div id="cutomerDetailsModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-center"><b>Informe de habitacion</b></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-responsive table-bordered">
                                ...
                                <tbody>
                                <tr>
                                    <td><b>Nombre del huesped</b></td>
                                    <td id="customer_name"></td>
                                </tr>
                                <tr>
                                    <td><b>Numero de contacto</b></td>
